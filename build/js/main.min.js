...
/* harmony import */ var _modules_change_pic__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/change-pic */ "./js/modules/change-pic.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_change_pic__WEBPACK_IMPORTED_MODULE_4__["initChangePic"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/change-pic.js":
/*!**********************************!*\
  !*** ./js/modules/change-pic.js ***!
  \**********************************/
/*! exports provided: initChangePic */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangePic", function() { return initChangePic; });
// Смена картинок в фильтре - начало -
var initChangePic = function initChangePic() {
  var parentList = document.querySelector('.size-and-price__filter-list.list-type');
  var picBoxSquare = document.querySelector('.pic--square');
  var picBoxAlbum = document.querySelector('.pic--album');
  var picBoxPortrait = document.querySelector('.pic--portrait');

  if (parentList && picBoxSquare && picBoxAlbum && picBoxPortrait) {
    var inputs = parentList.querySelectorAll('.size-and-price__filter-switch');
